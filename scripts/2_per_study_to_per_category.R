...
write.table(pseudoexon_sre$POS, file ='../data/splicing_altering/per_category/pe_activation/sre_associated/position_positive.txt', 
          quote = F,
          row.names = F,
          col.names = F)
write.table(pseudoexon_new_donor$POS, file ='../data/splicing_altering/per_category/pe_activation/new_donor/position_positive.txt', 
            quote = F,
            row.names = F,
            col.names = F)
write.table(pseudoexon_donor_associated$POS, file ='../data/splicing_altering/per_category/pe_activation/donor_associated/position_positive.txt', 
            quote = F,
            row.names = F,
            col.names = F)
write.table(pseudoexon_new_acceptor$POS, file ='../data/splicing_altering/per_category/pe_activation/acceptor_associated/position_positive_new_acceptor.txt',
            quote = F,
            row.names = F,
            col.names = F)
write.table(pseudoexon_acceptor_associated$POS, file ='../data/splicing_altering/per_category/pe_activation/acceptor_associated/position_positive_acceptor_associated.txt', 
            quote = F,
            row.names = F,
            col.names = F)
...
write.table(exon_extension_sre$POS, file ='../data/splicing_altering/per_category/exon_elongation/sre_associated/position_positive.txt', 
            quote = F,
            row.names = F,
            col.names = F)
write.table(exon_extension_new_donor$POS, file ='../data/splicing_altering/per_category/exon_elongation/new_donor/position_positive.txt', 
            quote = F,
            row.names = F,
            col.names = F)
write.table(exon_extension_donor_associated$POS, file ='../data/splicing_altering/per_category/exon_elongation/donor_associated/position_positive.txt', 
            quote = F,
            row.names = F,
            col.names = F)
write.table(exon_extension_new_acceptor$POS, file ='../data/splicing_altering/per_category/exon_elongation/acceptor_associated/position_positive_new_acceptor.txt', 
            quote = F,
            row.names = F,
            col.names = F)
write.table(exon_extension_acceptor_associated$POS, file ='../data/splicing_altering/per_category/exon_elongation/acceptor_associated/position_positive_acceptor_associated.txt', 
            quote = F,
            row.names = F,
            col.names = F)
...
write.table(head(sre_associated, 90) %>% pull(POS), file ='../data/splicing_altering/per_category/pe_activation/sre_associated/position_negative.txt', 
            quote = F,
            row.names = F,
            col.names = F) 
write.table(tail(sre_associated, 33) %>% pull(POS), file ='../data/splicing_altering/per_category/exon_elongation/sre_associated/position_negative.txt', 
            quote = F,
            row.names = F,
            col.names = F) 
...
write.table(other_neutral %>% filter(Effect_category == "new_splice_acceptor" | (Effect_category == "closer_to_acceptor" & offset >= 150)) %>% pull(POS), file = '../data/splicing_altering/per_category/pe_activation/acceptor_associated/position_negative.txt', quote=F, row.names = F, col.names = F)
write.table(other_neutral %>% filter(Effect_category == "strengthening_acceptor" | (Effect_category == "closer_to_acceptor" & offset < 150)) %>% pull(POS), file = '../data/splicing_altering/per_category/exon_elongation/acceptor_associated/position_negative.txt', quote=F, row.names = F, col.names = F)
...
write.table(pseudoexon_donor_associated %>% pull(POS), file ='../data/splicing_altering/per_category/pe_activation/donor_associated/position_negative.txt', 
            quote = F,
            row.names = F,
            col.names = F) 

write.table(pseudoexon_new_donor %>% pull(POS), file ='../data/splicing_altering/per_category/pe_activation/new_donor/position_negative.txt', 
            quote = F,
            row.names = F,
            col.names = F) 
...
write.table(elongation_donor_associated %>% pull(POS), file ='../data/splicing_altering/per_category/exon_elongation/donor_associated/position_negative.txt', 
            quote = F,
            row.names = F,
            col.names = F) 

write.table(elongation_new_donor %>% pull(POS), file ='../data/splicing_altering/per_category/exon_elongation/new_donor/position_negative.txt', 
            quote = F,
            row.names = F,
            col.names = F) 
